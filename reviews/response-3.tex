...
I was anticipating criticism from Doug Brinkerhoff.
...
I think the fact that melt fraction dependence is not constrained very well means users are \emph{more} likely to change this in their code than if we did have good data.
After all, if the data were good then we could just use whatever parameterization the experimentalists told us to and no one would ever have to touch it.
...
I think this falls under the heading of expert knowledge of glaciology and not of numerics.
To give an extreme example, early on in grad school I was making a simulation of several Greenland glaciers and my officemate gave me the helpful advice to increase the fluidity of ice that would have accumulated during the last glacial period because of the dustier atmosphere.
To use your phrase from before, we provide policies about numerics and mechanisms for physics.
