...
The implicit Euler scheme requires solving a non-symmetric linear system, but the extra computational cost comes with the advantage of unconditional stability.
