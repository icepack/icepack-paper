...
One key limitation of our approach is that users can change individual terms of the action functional but they cannot add or remove terms.
This calls for creating an entirely new diagnostic model.
