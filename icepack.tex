...
\begin{enumerate}
    ...
    \item reconstructing what glaciers of the near- or distant-past may have looked like \citep{marshall2002north}.
\end{enumerate}
...
Finally, the Gauss-Newton solver defines an approximation to the ``first-order'' part of the objective functional Hessian \citep{pratt1998gauss}.
