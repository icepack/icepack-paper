...
\begin{figure}[h]
    ...
    \caption{Synthetic ice sheet simulation: (a) the bed elevation profile consists of a ring of mountains with valleys of varying depth surrounding a flat plateau where the ice is initialized to (b) the change in thickness over the simulation period}
    \label{fig:ice-sheet}
\end{figure}
...
Users are free to decide whichever model is most appropriate for the spatial and temporal scales of their problem.
