...
Icepack is built on the finite element modeling library firedrake, which uses the domain-specific language UFL for the describing of weak forms of partial differential equations.
...
The horizontal velocity for many realistic flows is very smooth as a function of depth.
