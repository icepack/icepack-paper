...
There are four diagnostic models implemented in icepack.
...
All the momentum transport models inherit a fundamental nonlinearity in the mechanics of ice flow.
...
Every momentum transport model in icepack is encapsulated in its own Python class.
...
Some low-level kernel code is always necessary for runtime efficiency but with Firedrake this responsibility is deferred to a code generator \citep{rathgeber2016firedrake}.
...
\begin{figure}[h]
    ...
    \caption{Results of ice shelf damage simulation: (a) ice velocity, (b) change in ice speed with and without damage, (c) thickness, and (d) damage field.}
    \label{fig:damage}
\end{figure}
