...
This problem has the apparent form of a conservative advection equation.
...
The first-order model is based on an asymptotic expansion of the Stokes equations in the ratio of the ice thickness to a typical horizontal length scale.
...
We depart from \citet{aschwandend2012enthalpy} in one respect.
...
To solve the advection equation, other packages use the streamlined upwind Petrov-Galerkin (SUPG) method for the timestepping scheme \citep{brinkerhoff2013data, larour2012continental}.
...
Some glaciologists may be unfamiliar with the Courant-Friedrichs-Lewy (CFL) condition.
...
We believe that this is because of two difficulties: (1) evaluating the degree to which usability is a rate-limiting factor and (2) concretely assessing what features make software tools more or less usable.
