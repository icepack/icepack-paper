...
We argue that employing only keyword arguments is a strength rather than weakness because it enhances readability and comprehensibility for the particular use case of calling a physics solver.
